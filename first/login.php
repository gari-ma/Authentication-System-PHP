  ...
  <form action="loginprocess.php" method="post">
      ...
      <div class="w-full  max-w-md mx-auto">
        <div class="header mb-4 flex">
            <p class="text-3xl font-bold "> Login Here </p>
        </div>
        ...
        <div class="flex flex-center items-center mb-8 justify-between">
          <button
            class="bg-blue-500 w-1/2    hover:bg-blue-300 text-white font-bold py-2 px-4 rounded focus:shadow-outline"
            type="submit"
          >
            Continue 
          </button>
